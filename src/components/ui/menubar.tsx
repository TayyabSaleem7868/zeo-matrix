...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn("flex h-10 items-center space-x-1 rounded-2xl border-2 border-border/50 bg-background/60 backdrop-blur-xl p-1 shadow-lg", className)}
    {...props}
  />
));
